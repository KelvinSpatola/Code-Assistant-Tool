...
Add contributed tools by selecting the menu item _Tools_ â†’ _Add Tool..._ This will open the Contribution Manager, where you can browse for Code Assistant, or any other tool you want to install.
